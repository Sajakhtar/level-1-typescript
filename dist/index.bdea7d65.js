...
var _interfacesDefault = parcelHelpers.interopDefault(_interfaces);
var isOpen = false;
var firstName = "Jon";
var age1 = 30.5;
var list = [
...
var job = _interfacesDefault.default.WebDesigner;
...
var sayWord = function(word) {
    ...
    var otherStuff = [];
    for(var _i = 1; _i < arguments.length; _i++)otherStuff[_i - 1] = arguments[_i];
    console.log(word);
...
parcelHelpers.export(exports, "Type2", ()=>Type21
);
var Job1;
(function(Job) {
...
},{}]},["2HtCd","7PGg5"], "7PGg5", "parcelRequire3b82")
